...
# Use this script to download a specific file from the bucket
...
# and file to be downloaded is folder/subFolder/file.extension
# The 'isAllowedFolder' method below takes path as an input
# Both 'folder/subFolder' and 'folder/subFolder/file.extnsion/'are the inputs
...
# The following method 'isAllowedFile' has the entire path to the file in quotes
# User should replace the value is quotes with their path to file 
def isAllowedFile(path):
    return 'folder/subFolder/file.extension/'.startswith(path)
